...
namespace DI
{
    public abstract class DIEntry : IDisposable
    {
        ...
        protected DIEntry(DIContainer container) => Container = container;
    ...
    public class DIEntry<T> : DIEntry
    {
        ...
        public DIEntry(DIContainer container, Func<DIContainer, T> factory) : base(container) => Factory = factory;
        ...
        public override void Dispose() => _disposableInstance?.Dispose();
    }
}